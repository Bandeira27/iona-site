...
const achievements: Achievement[] = [
  {
    ...
    title: "Psicologia",
    description:
      "Começou ouvindo — crianças e famílias. A pergunta era simples: o que faz uma vida valer a pena viver?",
  },
  {
    year: "2002",
  ...
  },
  {
    ...
    title: "Stanford",
    description:
      "Foi estudar como a educação muda culturas. Saiu de lá com uma nova convicção: o futuro se constrói com método.",
  },
  {
    year: "2013–2024",
    title: "Vale do Silício",
    description:
      "Onze anos no epicentro da inovação. Liderou, criou filhos e aprendeu na prática que o novo precisa de cultura pra durar.",
  },
  {
    year: "2020",
    title: "Fundadora",
    description:
      "Criou a Education Journey, uma edtech que personaliza o aprendizado com IA. Mas logo entendeu: tecnologia sozinha não transforma. Cultura, sim.",
  },
  {
    year: "Hoje",
    title: "Especialista em IA como cultura",
    description:
      "Atua com executivos e conselhos que já aprovaram a IA — mas ainda não a integraram. A virada real começa aqui: na forma como se decide, se lidera e se aprende.",
  },
];
