     ...
     <section className="framer-1fsg44c" data-framer-name="Details Section">
      ...
      >
        <div className="framer-jtn3t6" data-framer-name="Content">
          ...
          <div className="framer-cwv9nj" data-framer-name="Details and Button">
            <div className="framer-1551dhi" data-framer-name="Details Wrapper">
              <div className="framer-xmdt4w" data-framer-name="Name and Details">
                <div className="framer-1qz7meh" data-framer-name="Name and Designation">
                  <div className="ssr-variant hidden-dmz5yz hidden-gmy0uk">
                    <div
                ...
                >
                  ...
                  >
                    Em tempos de medo do futuro, quem está preparando o presente?
                  </p>
                </div>
                ...
                >
                  ...
                  >
                    A inteligência artificial acelerou o tempo, mas a maioria das empresas ainda
                    tenta operar com os códigos do passado.
                  </p>
                </div>
              </div>
              ...
              <div className="framer-kpe8k">
                ...
                >
                  ...
                  >
                    Enquanto muitos falam sobre o que vem por aí, Iona atua no agora: acelerando a
                    transição entre a disrupção tecnológica e a maturidade cultural necessária para
                    enfrentá-la.
                  </p>
                </div>
              </div>
