    ...
    <ScrollReveal>
      ...
      >
        <div className="framer-8eb8eu" data-framer-name="Content">
            ...
            <div className="framer-1xsu27j">
              ...
              >
                <img
                  ...
                  height="2030"
                  sizes="500px"
                  srcSet="https://framerusercontent.com/images/ngYagQaUW4Ja6DkWtkFU1VHV0.png?scale-down-to=512 512w,https://framerusercontent.com/images/ngYagQaUW4Ja6DkWtkFU1VHV0.png?scale-down-to=1024 1024w,https://framerusercontent.com/images/ngYagQaUW4Ja6DkWtkFU1VHV0.png?scale-down-to=2048 2048w,https://framerusercontent.com/images/ngYagQaUW4Ja6DkWtkFU1VHV0.png 3101w"
                  src="https://framerusercontent.com/images/ngYagQaUW4Ja6DkWtkFU1VHV0.png"
                  alt=""
                  style={{
                    display: 'block',
                    width: '100%',
          ...
          <div className="framer-skvjdz" data-framer-name="Details and Button">
            <div className="framer-pn4u26" data-framer-name="Details Wrapper">
              <div className="framer-1ruk4j7" data-framer-name="Name and Details">
                <div className="framer-jlwb8m" data-framer-name="Name and Designation">
                  <div className="ssr-variant hidden-dmz5yz hidden-gmy0uk">
                    <div
                ...
                >
                  ...
                  >
                    Cursos de prompt. Hackathons de IA. Ferramentas novas a cada semana
                  </p>
                </div>
                ...
                >
                  ...
                  >
                    E, ainda assim, a sensação é de que a transformação não chegou.
                  </p>
                </div>
              </div>
              ...
              <div className="framer-13tmha0">
                ...
                >
                  ...
                  >
                    É porque a IA não se implementa de fora pra dentro. Iona entendeu isso e ajuda a
                    ajustar a cultura para operar com IA no centro: mudando normas culturais,
                    reorganizando fluxos de decisão e formando lideranças AI-first.
                  </p>
                </div>
              </div>
            </div>
