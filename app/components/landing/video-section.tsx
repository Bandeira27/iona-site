  ...
  return (
    <div className="ssr-variant hidden-gmy0uk">
      <section className="framer-wrslx1" data-framer-name="Video Section">
        ...
        {/* Content Container */}
        <div className="framer-6ytr7r" data-framer-name="Container" style={{ willChange: 'transform', opacity: 1, transform: 'none' }}>
        ...
        <div className="framer-a0vlds" data-framer-name="Content">
          <div
            ...
            id="1cbwipx"
            tabIndex={0}
            style={{ position: 'relative', width: '120px', height: '120px', margin: '0 auto' }}
          >
            {/* Pulse Indicator */}
       <motion.div
  style={{
...
/>
    ...
    >
      ...
      <div className="framer-1t4336-container">
        <div onClick={() => setPreviewVideo(false)} style={{ display: "contents" }}>
          <svg
