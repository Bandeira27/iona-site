      ...
      <section className="framer-wrslx1" data-framer-name="Video Section">
        ...
        <div className="framer-a0vlds" data-framer-name="Content">
          ...
          >
            ...
            <div className="framer-11hlald-container">
              <div
                className="framer-IeNky framer-1xaqo4j framer-v-1xaqo4j"
                data-framer-name="Play Pulse"
                tabIndex={0}
                style={{ height: "100%", width: "100%", opacity: 1 }}
              >
                {/* Motion exatamente igual ao exemplo (pulse) */}
                <motion.div
                  className="framer-9rmh5v"
                ...
                {/* Outer Circle (mantido como estava) */}
                <div
          ...
          >
            ...
            >
              Se você não vai até o Vale do Silício, Iona leva ele até você
            </h2>
          </div>
        </div>
      </section>
          ...
          >
            ...
            <div className="framer-1t4336-container">
              ...
              >
                ...
                >
                  <g color="rgb(255,255,255)" height="bold">
