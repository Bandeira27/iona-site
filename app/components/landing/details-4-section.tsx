...
import ImageIonaDetails4 from "@/app/assets/images/image-iona-details-four.png";
import Image from "next/image";

export default function Details4Section() {
  return (
    <ScrollReveal>
      <section className="framer-1km4zoh" data-framer-name="Details Section">
        <div
          className="framer-11xa1f1"
          data-framer-name="Container"
          style={{ willChange: "transform", opacity: 1, transform: "none" }}
        >
          <div className="framer-1ex8xob" data-framer-name="Content">
            <div className="framer-1wk2009">
              <div
            ...
            <div
              className="framer-4aqxas"
              data-framer-name="Details and Button"
            >
              <div className="framer-a1ptbc" data-framer-name="Details Wrapper">
                <div
                  className="framer-1747zlh"
                  data-framer-name="Name and Details"
                >
                  <div
                    className="framer-19mnyjm"
                    data-framer-name="Name and Designation"
                  >
                    <div
                      className="framer-cu0hbb"
                ...
                <div className="framer-7lk405">
                  <div className="framer-1mg15tn" data-framer-name="line"></div>
                  <div
                    className="framer-mzxm4z"
                    data-framer-component-type="RichTextContainer"
                    style={{
                      outline: "none",
                      display: "flex",
