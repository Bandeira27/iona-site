        ...
        <div className="framer-1l9xh76" data-framer-name="Content">
          ...
          <div className="framer-125149r" data-framer-name="Card Wrapper">
            ...
            <LectureCard
              ...
              description="Apresenta o líder algorítmico, conceitos autorais e alinha temas de liderança com disrupção tecnológica."
            />
            <LectureCard
              image={ImageCup}
            ...
            <LectureCard
              ...
              description="Encontros de RH, lideranças em transformação, C-levels em virada estratégica."
            />
          </div>
        </div>
      </div>
