  ...
  return (
   <ScrollReveal>
     <section className="framer-gm64b5" data-framer-name="Details Section">
      <div
        className="framer-42qcrx"
        data-framer-name="Container"
        style={{ willChange: 'transform', opacity: 1, transform: 'none' }}
      >
        <div className="framer-b990yu" data-framer-name="Content">
          <div className="framer-1ro2m7l" data-framer-name="Details and Button">
            <div className="framer-sqlivn" data-framer-name="Details Wrapper">
              <div className="framer-1tutnmb" data-framer-name="Name and Details">
                <div className="framer-v0z11w" data-framer-name="Name and Designation">
                  <div className="ssr-variant hidden-dmz5yz hidden-gmy0uk">
                    <div
                      className="framer-akqb0z"
                      style={{
                        outline: 'none',
                        display: 'flex',
                ...
                >
                  ...
                  >
                    Iona viveu por mais de uma década no epicentro da inovação global.
                  </p>
                </div>

                <div
                  className="framer-12pfups"
                  style={{
                    outline: 'none',
                    display: 'flex',
                    flexDirection: 'column',
                ...
                >
                  ...
                  >
                    Estudou em Stanford, foi executiva, criou filhos e mergulhou em uma cultura que
                    normaliza o novo todos os dias.
                  </p>
                </div>
              </div>

              <div className="framer-1y9lw85">
                <div className="framer-1dog78p" data-framer-name="line" />
                <div
                  className="framer-6sjww5"
                  style={{
                    outline: 'none',
                    display: 'flex',
                    flexDirection: 'column',
                ...
                >
                  ...
                  >
                    Lá, aprendeu que sucesso tem método e existe um jeito de traduzir essa
                    mentalidade para o Brasil.
                  </p>
                </div>
              </div>
            </div>
