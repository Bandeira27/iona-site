        ...
        <div className="framer-1lkc411" data-framer-name="Content">
          <div className="ssr-variant hidden-s0e53g hidden-ikujzk">
            <div className="framer-72ppi7-container">
              ...
              >
                <div
                  className="framer-6flqkc"
                  data-framer-name="Links and Copyright"
                  style={{ opacity: 1 }}
                >
                  <div
                    className="framer-6sfvaz"
                    data-framer-name="Info and Links"
                    style={{ opacity: 1 }}
                  >
                    <div
                      className="framer-1nrn3p4"
                      data-framer-name="Description and Awards"
                      style={{ opacity: 1 }}
                    >
                      <div
                        className="framer-xj7acp"
                        data-framer-name="Logo and Text"
                        style={{ opacity: 1 }}
                      >
                        <div
                          className="framer-1pfexyp"
                          data-framer-name="logo"
                          style={{ opacity: 1 }}
                        >
                          <div
                            className="framer-rt3odc"
                            data-framer-name="Logo"
                            style={{ opacity: 1 }}
                          >
                            <div
                            ...
                            >
                              <img
                                ...
                                width="165"
                                height="50"
                                src="https://framerusercontent.com/images/thO1ePQbs8ZtHboCn7RHCo6TXo.svg"
                                alt="Logo"
                                style={{
                                  display: 'block',
                                  width: '100%',
                        ...
                        >
                          ...
                          >
                            Não existe entrega pronta. Existe o que o seu momento pede.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            Se sua empresa está em fase de expansão, reorganização ou repensando o
                            papel da IA na liderança, talvez essa seja a conversa que precisa
                            acontecer agora.
                          </p>
                        </div>
                      </div>
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{ opacity: 1 }}
                    >
                      <div className="framer-24l3r3-container" style={{ opacity: 1 }}>
                        <a
                          className="framer-D6dDG framer-1u3fz7h framer-v-1u3fz7h framer-10jjh2a"
                          data-framer-name="Social Icon"
                          href="https://x.com/iona_nita"
                          target="_blank"
                          rel="noopener"
                          style={{ opacity: 1 }}
                        >
                          <div className="framer-1xj7lrz-container" style={{ opacity: 1 }}>
                      ...
                      <div className="framer-1hwsa75-container" style={{ opacity: 1 }}>
                        <a
                          className="framer-D6dDG framer-1u3fz7h framer-v-1u3fz7h framer-10jjh2a"
                          data-framer-name="Social Icon"
                          href="https://www.instagram.com/ionaszkurnik.ia/?hl=pt"
                          target="_blank"
                          rel="noopener"
                          style={{ opacity: 1 }}
                        >
